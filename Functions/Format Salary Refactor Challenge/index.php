...
//         $average += ($listing['salary'] / count($jobListings));
//     }
//     return $average;
// }

// $averageSalary = calculateAverageSalary($listings);
// $formattedSalary = formatSalary($averageSalary);

function calculateAverageSalary($jobListings, $formatSalary) // we have passed in formatSalary as a callback
{
...
$averageSalary = calculateAverageSalary($listings, $formatSalary);

<?php
// The $_GET superglobal is used get varibale sent to your script via GET request usually through query parameters.

// echo isset($_GET['name']) ? ($_GET['name']) : '';
// echo htmlspecialchars($_GET['age'] ?? )'';  // The htmlspecialchars() prevents js scripts that may have been passed in the request url from being run.
// You have to be aware of what data you are getting from users and whether you should display in on the browser.
